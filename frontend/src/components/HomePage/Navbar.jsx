    ...
    <div className="flex items-center justify-between px-16 py-4 bg-[#0b0f1a]">
      ...
      <div className="flex items-center">
        <div className="w-6 h-6 overflow-hidden">
          <img src={logo} className="w-full h-full object-contain scale-[0.4]" />
        </div>
      ...
      <div className="flex items-center gap-10">
        <h4 className="text-white cursor-pointer">Features</h4>
        <h4 className="text-white cursor-pointer">Take Survey</h4>
